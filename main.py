...
def ip_pinger_download(run_option, return_to_menu=True):
...
def b64_download(run_option, return_to_menu=True):
...
def username_lookup_download(run_option, return_to_menu=True):
...
def ip_lookup_download(run_option, return_to_menu=True):
...
def webhook_mutltitool_download(run_option, return_to_menu=True):
...
def site_checker(run_option, return_to_menu=True):
...
def pwd_strength_checker(run_option, return_to_menu=True):
...
def tools_menu():
    ...
    print("                     [2] - IP Pinger                    [5] - Username Lookup")
    print("                     [3] - Site Multitool               [6] - Password Strength Checker")
    option = input("Option >> ")
    if option == '1':
        run_option = input("You wanna run the tool? [Y or N] >> ")
        ip_lookup_download(run_option)
    elif option == '2':
        run_option = input("You wanna run the tool? [Y or N] >> ")
        ip_pinger_download(run_option)
    elif option == '3':
        run_option = input("You wanna run the tool? [Y or N] >> ")
        site_checker(run_option)
    elif option == '4':
        run_option = input("You wanna run the tool? [Y or N] >> ")
        b64_download(run_option)
    elif option == '5':
        run_option = input("You wanna run the tool? [Y or N] >> ")
        username_lookup_download(run_option)
    elif option == '6':
        run_option = input("You wanna run the tool? [Y or N] >> ")
        pwd_strength_checker(run_option)
    elif option == '7':
        run_option = input("You wanna run the tool? [Y or N] >> ")
        webhook_mutltitool_download(run_option)
    elif option == '99':
        update()
    elif option == '404':
        print("Returning...")
...
def main():
    ...
    print("\n                                   [1]  - Install Discord Tools = Webhook spammer")
    ...
    if option == '1':
        run_option = input("You wanna run the tool? [Y or N] >> ")
        webhook_mutltitool_download(run_option, return_to_menu=False)
    elif option == '2':
        ip_lookup_download(run_option='n', return_to_menu=False)
        ip_pinger_download(run_option='n', return_to_menu=False)
        site_checker(run_option='n', return_to_menu=False)
